...
import { setGetTotals } from "../app/CartSlice.js"
        ...
        >
          ...
          {cartItems.length === 0 ? (
            ...
            <div>
              ...
              <div className="fixed bottom-0 bg-[#fff] w-full px-5 py-5 grid items-center">
                ...
                <div className="grid items-center gap-2">
                  ...
                  <button
                    type="button"
                    className="button-theme bg-theme-cart text-[#fff]"
                  >
                    Check Out
                  </button>
                </div>
